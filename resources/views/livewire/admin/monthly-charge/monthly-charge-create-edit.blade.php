<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
        ...
        <x-admin.form-group>
            <x-admin.lable value="Service Charge"   />
            <x-admin.input type="text" wire:model.defer="service_charge" placeholder="service Charge"  class="{{ $errors->has('service_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="service_charge" />
        </x-admin.form-group>

        <x-admin.form-group>
            <x-admin.lable value="Security Charge"   />
            <x-admin.input type="text" wire:model.defer="security_charge" placeholder="security Charge"  class="{{ $errors->has('security_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="security_charge" />
        </x-admin.form-group>

        <x-admin.form-group>
            <x-admin.lable value="Electricity Charge"   />
            <x-admin.input type="text" wire:model.defer="electricity_charge" placeholder="electricity Charge"  class="{{ $errors->has('electricity_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="electricity_charge" />
        </x-admin.form-group>

        <x-admin.form-group>
            <x-admin.lable value="Water Charge"   />
            <x-admin.input type="text" wire:model.defer="water_charge" placeholder="water Charge"  class="{{ $errors->has('water_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="water_charge" />
        </x-admin.form-group>

        <x-admin.form-group>
            <x-admin.lable value="Maintainence Charge"   />
            <x-admin.input type="text" wire:model.defer="maintainence_charge" placeholder="maintainence Charge"  class="{{ $errors->has('maintainence_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="maintainence_charge" />
        </x-admin.form-group>

        <x-admin.form-group>
            <x-admin.lable value="Other Expenses Charge"   />
            <x-admin.input type="text" wire:model.defer="other_expenses_charge" placeholder="other_expenses Charge"  class="{{ $errors->has('other_expenses_charge') ? 'is-invalid' :'' }}" />
            <x-admin.input-error for="other_expenses_charge" />
        </x-admin.form-group>
    ...
    <x-slot name="actions">
        ...
        <x-admin.link :href="route('monthly-charge.index')" color="secondary">Cancel</x-admin.link>
    </x-slot>
</x-form-section>
