        ...
        @forelse($details as $item)
            <tr role="row" class="odd">
                ...
                @else 
                    <td></td>
                @endif
                @if (isset($item->receiver->first_name))
                ...
                <x-admin.td-action>
                <a class="dropdown-item" href="{{route('monthly-charge.show', ['monthly_charge' => $item->id])}}" ><i class="la la-eye"></i> Show</a>
                <a class="dropdown-item" href="{{route('monthly-charge.edit', ['monthly_charge' => $item->id])}}" ><i class="la la-edit"></i> Edit</a>
                </x-admin.td-action>
            </tr>
        @empty
            <tr>
