...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-7">
            ...
            <div class="u-container-layout u-container-layout-2"><span class="u-custom-color-1 u-icon u-icon-circle u-text-white u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 60 60" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-b149"></use></svg><svg class="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px" id="svg-b149" style="enable-background:new 0 0 60 60;"><path d="M48.014,42.889l-9.553-4.776C37.56,37.662,37,36.756,37,35.748v-3.381c0.229-0.28,0.47-0.599,0.719-0.951
...
<section class="u-section-2">
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <img src="{{asset('welcome_assets/images/sec-images.jpg')}}" class="u-align-left u-image u-image-default u-image-1" width="1280" height="853"/>
                <img src="{{asset('welcome_assets/images/sec-images2.jpg')}}" class="u-align-left u-image u-image-default u-image-2" width="1280" height="853"/>
            </div>
            <div class="col-sm-4">
                <h2>Inspired by living</h2>
...
<section class="u-custom-color-1">
    <div class="container">
        <div class="row">
            ...
            <svg class="u-svg-content" viewBox="0 0 511.998 511.998" x="0px" y="0px" id="svg-d001" style="enable-background:new 0 0 511.998 511.998;"><g><g><path d="M74.664,85.179c-17.673,0-32,14.327-32,32v85.333h21.333v-85.333c0-5.891,4.776-10.667,10.667-10.667h256V85.179H74.664z"></path>
            </g>
            ...
            <div class="col-sm-4">
                ...
                <svg class="u-svg-content" viewBox="0 0 511.998 511.998" x="0px" y="0px" id="svg-d001" style="enable-background:new 0 0 511.998 511.998;"><g><g><path d="M74.664,85.179c-17.673,0-32,14.327-32,32v85.333h21.333v-85.333c0-5.891,4.776-10.667,10.667-10.667h256V85.179H74.664z"></path>
                 ...
                 <h3 class="u-text u-text-1">Modeling</h3>
                 <div class="u-align-left u-border-3 u-border-white u-line u-line-horizontal u-line-1"></div>
                 <p class="u-text u-text-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.</p>
                ...
                <div class="col-sm-4">
                    ...
                    <svg class="u-svg-content" viewBox="0 0 511.998 511.998" x="0px" y="0px" id="svg-d001" style="enable-background:new 0 0 511.998 511.998;"><g><g><path d="M74.664,85.179c-17.673,0-32,14.327-32,32v85.333h21.333v-85.333c0-5.891,4.776-10.667,10.667-10.667h256V85.179H74.664z"></path>
                     ...
                     <h3 class="u-text u-text-1">Building</h3>
                     <div class="u-align-left u-border-3 u-border-white u-line u-line-horizontal u-line-1"></div>
                     <p class="u-text u-text-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.</p>
...
<section class="u-section-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
               <div class="text-center"> <img src="{{asset('welcome_assets/images/logo.png')}}" class="u-image-1"/></div>
                <h5>Welcome to our Soceity</h5>
                <p class="u-text u-text-2"> Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.</p>
            </div>
            <div class="col-sm-5">
                <div class="u-custom-color-1 u-shape u-shape-rectangle u-shape-1"></div>
                <img src="{{asset('welcome_assets/images/1723651f54c9a290a9773c2687d230049889cd369abd5fe8c50a83326b3bda4dade74d940b80bf810203faf0a799ec03ca9735f7d912503e653435_1280.jpg')}}" alt="" class="u-align-left u-image u-image-default u-opacity u-opacity-45 u-image-2" data-image-width="1280" data-image-height="853">
                <img src="{{asset('welcome_assets/images/67026135ee7660e0855d1ecdd7b7fe4e1bfc0d43d9660d37b9ae5dda5130300216d27336d57737681a601c80a1af35720291abd9f8493a54ae1b62_1280.jpg')}}" alt="" class="u-align-left u-image u-image-default u-image-3" data-image-width="1280" data-image-height="853">
            </div>
        </div>
    </div>
</section>
<section class="u-clearfix u-custom-color-1 u-section-6">
    <div class="container">
        <div class="row">
            <div class="col-sm-4"><img src="{{asset('welcome_assets/images/new1.jpeg')}}"/></div>
            <div class="col-sm-4"><img src="{{asset('welcome_assets/images/new1.jpeg')}}"/></div>
            <div class="col-sm-4"><img src="{{asset('welcome_assets/images/new1.jpeg')}}"/></div>
        </div>
        <div class="row">
